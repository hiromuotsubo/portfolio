...
// Journey V3-only checkpoints. Each state uses Journey V1's real progress,
...
const DEV_PREVIEW = Object.hasOwn(PREVIEW_STATES, REQUESTED_PREVIEW)
  ? REQUESTED_PREVIEW
  : null
...
const getRouteFromLocation = () => {
  ...
  if (pathname === '/journey-v3') return { view: 'journey', page: null }
    ...
    <section className="portfolio-story portfolio-page is-project" aria-labelledby="project-title">
      ...
      <div className="portfolio-story__panels">
        ...
        <article id="emotion" className={panelClassName('emotion', 'is-emotion-panel')} data-story-panel="emotion">
          ...
          <div className="portfolio-panel__copy"><span className="portfolio-kicker">EMOTION</span><h3>Wonder grows in quiet moments.</h3><p>The journey ends beneath an immense night sky.<br />Nothing changes around.<br />Only the way you feel.</p><button type="button" onClick={onReplay}>EXPERIENCE AGAIN <NavigationArrow /></button></div>
        </article>
        <footer className="portfolio-story__end">
        ...
        {page === 'home' ? (
          <section className="portfolio-home portfolio-page" aria-labelledby="portfolio-home-title">
            ...
            <div className="portfolio-home__copy">
              ...
              <button type="button" onClick={onReplay}><span>EXPERIENCE AGAIN</span><NavigationArrow /></button>
            </div>
          </section>
        ) : null}
        ...
        {page === 'contact' ? (
          <section className="portfolio-contact portfolio-page" aria-labelledby="contact-title">
            ...
            <div className="portfolio-contact__links">
              ...
              <a href="https://note.com/tabonnu" target="_blank" rel="noreferrer"><small>WRITING</small><span>note / tabonnu</span><NavigationArrow kind="external" /></a>
            </div>
...
function JourneyV3Experience() {
  ...
  const [showOutro, setShowOutro] = useState(
    PREVIEW_SHOW_OUTRO || INITIAL_VIEW === 'portfolio',
  )
  const [showPortfolio, setShowPortfolio] = useState(
    INITIAL_VIEW === 'portfolio',
  )
  ...
  const riverCompletedRef = useRef(PREVIEW_SKY_CONNECTION >= 1)
  ...
  const portfolioRef = useRef(INITIAL_VIEW === 'portfolio')
  ...
  const replayExperience = useCallback(() => {
    resetExperience()
    window.history.pushState(null, '', `/journey-v3${window.location.search}`)
  }, [resetExperience])
    ...
    >
      ...
      {!showPortfolio ? (
        <ExperienceLoader
          ...
          previewLoading={DEV_PREVIEW === 'loading'}
        />
      ) : null}

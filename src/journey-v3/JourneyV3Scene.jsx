...
export default function JourneyV3Scene({
  ...
  useEffect(() => {
    const frame = window.requestAnimationFrame(() => {
      onAssetsReady?.({ active: false, progress: 100 })
    })
    return () => window.cancelAnimationFrame(frame)
  }, [gltf.scene, onAssetsReady, phase2Gltf.scene])
  ...
  const neutralPointerRef = useRef(new THREE.Vector2())
  ...
  useFrame((state, delta) => {
    ...
    if (camera?.isCamera) {
      ...
      const vistaComposition = smoothstep(
        JOURNEY_V1_COMPOSITION.vistaStart,
        JOURNEY_V1_COMPOSITION.vistaFull,
        cameraProgress,
      ) * (1 - smoothstep(
        JOURNEY_V1_COMPOSITION.vistaFadeStart,
        JOURNEY_V1_COMPOSITION.vistaFadeEnd,
        cameraProgress,
      ))
      ...
      camera.position.addScaledVector(
        ...
        (presentationMode ? -1.8 : 0) -
          vistaComposition * JOURNEY_V1_COMPOSITION.pullBack -
      ...
      camera.position.y +=
        verticalBob +
        vistaComposition * JOURNEY_V1_COMPOSITION.cameraLift +
      ...
      cameraScratch.target.y +=
        ...
        vistaComposition * JOURNEY_V1_COMPOSITION.targetLift +
      ...
      const desiredFov =
        ...
        openVista * 4.5 +
        vistaComposition * JOURNEY_V1_COMPOSITION.fov +
